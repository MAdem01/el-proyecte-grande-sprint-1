    ...
    <nav className="navbar">
      <div className="navbar-left">
        <ul className="navbar-left-links">
          ...
          <li>
            <a className="homeButton" onClick={() => navigate('/')}>
              Home
            </a>
          </li>
          <li>
            <a className="homeButton" onClick={() => navigate('/football-games')}>
              Play Football
            </a>
          </li>
          {isAdmin() && (
            <li>
              <a className="homeButton" onClick={() => navigate('/admin/addmatch')}>
                Add Match
              </a>
            </li>
          )}
      ...
      <div className="navbar-right">
        ...
        (userInfo && userInfo.authorities && userInfo.authorities[0]?.authority === 'ROLE_ADMIN') ? (
          <ul className="navbar-right-links">
            <li>
              <FontAwesomeIcon icon={faUser} style={{ color: 'black', transform: 'scale(2)' }} onClick={() => navigate(`/user/${userInfo.userId}`)} />
            </li>
            <li>
              <a className="register-button" onClick={handleLogOut}>
                Log Out
              </a>
            </li>
          </ul>
          ...
          <ul className="navbar-right-links">
            <li>
              <a className="login-button" href="/users/login">
                Login
              </a>
            </li>
            <li>
              <a className="register-button" href="/users/register">
                Register
              </a>
            </li>
          </ul>
